<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="">
                <img src="{{ asset('images/logo.png') }}" style="width: 70px; height: 40px;" alt="logo" class="logo-default" /> </a>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                {{-- <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <ul id="number_notification" class="dropdown-menu-list scroller" style="height: 250px;"
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        ...
                        <span class="username username-hide-on-mobile">
                            <?php if(Auth::guard('admin')->check()) { echo Auth::guard('admin')->user()->name; } ?>
                        </span>
